...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rst2pdf-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6634&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rst2pdf-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rst2pdf` can be installed with:

```
conda install rst2pdf
```

It is possible to list all of the versions of `rst2pdf` available on your platform with:
